...
ExecStart=/var/www/myproject/venv/bin/gunicorn --workers 3 --bind unix:/var/www/myproject/gunicorn.sock middleware_dashboard.wsgi:application
...
```ini
ExecStart=/var/www/myproject/venv/bin/gunicorn --workers 3 --timeout 300 --bind unix:/var/www/myproject/gunicorn.sock middleware_dashboard.wsgi:application
```
