# Generated by Django 4.2.7 on 2025-12-16 09:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('update_type', models.CharField(choices=[('product', 'Product Update'), ('stock', 'Stock Update'), ('price_cost', 'Price Update (Cost)'), ('price_mrp', 'Price Update (MRP)'), ('price_both', 'Price Update (Both)'), ('rules_price', 'Rules Update (Price/Margin)'), ('rules_stock', 'Rules Update (Stock)'), ('bulk_creation', 'Bulk Item Creation')], max_length=20)),
